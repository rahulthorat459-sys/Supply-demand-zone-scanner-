...
TIMEFRAME_CONFIG = {
    # Location / Trend / Execution are displayed separately; the execution
    # interval below is the candle timeframe used for zone prices.
    ...
    for record in records:
        ...
        for zone in record.get("zones") or []:
            ...
            if zone_type not in ("supply", "demand"):
                continue
            # Trend/break information is display-only. Do not use the trend
            # or break count to select/remove stocks from the candidate list.
            # The existing four evaluator rules above remain unchanged.
